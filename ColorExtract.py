...
# The function is operate by capture and
# display a screenshot when the program is ran
# As the mouse move through displayed screenshot
# window HSV and BGR value are displayed in terminal
# The x and y coordinate need to be calibrate to the window,
# its currently calibrated to ubuntu with menu on the right hand side
